...
public interface InquiryMapper {
    ...
    InquiryDto getInquiryDetail(SearchCriteria searchCriteria);

    int addResponse(@Param("searchCriteria") UpdateCriteria updateCriteria, @Param("stat") InquiryStat stat);
}
